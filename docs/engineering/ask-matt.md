...
- **A discipline layer underneath**, the four references the other skills pull in: two vocabulary references for when the words rather than the process are the problem, plus [clean-code](https://aihero.dev/skills-clean-code) and [clean-architecture](https://aihero.dev/skills-clean-architecture) for how the code and its boundaries get built.
