...
- Standards and Spec findings arrive in two distinct blocks, each citing its source — a repo standard, clean-code/clean-architecture principle, or baseline smell for one, a quoted spec line for the other.
