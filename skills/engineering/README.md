...
- **[clean-code](./clean-code/SKILL.md)**: Pragmatic code-level principles for readable intent, cohesive units, explicit effects, useful errors, behavior-focused tests, and safe incremental refactoring.
- **[clean-architecture](./clean-architecture/SKILL.md)**: Protect business policy through justified boundaries, inward source dependencies, isolated mechanisms, and executable architecture rules.
- **[code-review](./code-review/SKILL.md)**: Two-axis review of the diff since a fixed point: **Standards** (repo standards plus the clean-code, relevant clean-architecture, and Fowler smell baselines) and **Spec** (does it faithfully implement the originating issue/spec?), run as parallel sub-agents.
